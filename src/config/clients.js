...
export const clients = {
  [CLIENT_KEYS.AL_RUKN_AL_YAMANI]: {
    ...
    about: {
      headline: 'جودة تراثية.. وأناقة عصرية',
      body: 'نقدم لكِ أجمل العبايات الخليجية المصممة بعناية من أفخم الأقمشة وعلى معايير الجودة لتكون خيارك الأول في الأناقة والراحة.',
      values: [
        { icon: 'Scissors', title: 'تصاميم عصرية', sub: 'بتفاصيل راقية' },
        { icon: 'Layers',   title: 'أقمشة فاخرة',   sub: 'مختارة بعناية' },
        { icon: 'Award',    title: 'جودة عالية',     sub: 'في كل قطعة' },
      ],
    },
    settings: {
  ...
  [CLIENT_KEYS.AL_BAYT_AL_KHALIJI]: {
    ...
    about: {
      headline: 'عبايات خليجي هندميد ❤️',
      body: 'جودة الخامه و دقة التنفيذ تجعلنا دائما متميزون في مجالنا و نسعي دائما للافضل من اجلكم 🤩\nالخامات: حرير - كتان - كوريشه - شيفون\nالمقاسات: متوفر كل المقاسات 🔍',
      values: [
        { icon: 'Award',    title: 'خامات راقية',   sub: 'حرير · كتان · كوريشه · شيفون' },
        { icon: 'Scissors', title: 'هندميد أصيل',   sub: 'تطريز يدوي بدقة عالية' },
        { icon: 'Layers',   title: 'كل المقاسات',   sub: 'متوفر جميع المقاسات' },
      ],
    },
    settings: {
